...
export const inspectionApi = {
  /** 积分流水分页。行类型缺省 = 生成物的 PointsLedgerItem。 */
  pointsLedger<T = PointsLedgerItem>(params: PointsLedgerParams) {
