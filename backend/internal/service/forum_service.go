...
type ForumTopicPageResult struct {
	...
	Topics []ForumTopicDTO `json:"topics" nullability:"nonnil"`
...
type ForumTopicDetailDTO struct {
	Page    int             `json:"page"`
	Pages   int             `json:"pages"`
	Replies []ForumReplyDTO `json:"replies" nullability:"nonnil"`
...
type MyReplyPageResult struct {
	...
	Pages   int          `json:"pages"`
	Total   int64        `json:"total"`
	Replies []MyReplyDTO `json:"replies" nullability:"nonnil"`
}
