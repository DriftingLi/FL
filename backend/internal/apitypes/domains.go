...
var Domains = []Domain{
	...
	{
		Name:  "training",
		Title: "培训目录与字典（/api/catalog|levels|tags|positions、/api/admin 下的专业方向 / 等级 / 证书模板 / 题库标签 / 岗位字典）",
		Roots: []string{
		...
		Endpoints: []Endpoint{
			...
			{Method: "GET", Path: "/admin/specialties"},
			...
			{Method: "GET", Path: "/admin/positions"},
			{Method: "POST", Path: "/admin/position"},
			{Method: "PUT", Path: "/admin/position/{position_id}"},
			{Method: "PUT", Path: "/admin/position/{position_id}/sort", NoData: true},
			{Method: "DELETE", Path: "/admin/position/{position_id}", NoData: true},
		},
	},
...

	{
		...
		Endpoints: []Endpoint{
			...
			{Method: "GET", Path: "/admin/recruit/requests"},
			{Method: "GET", Path: "/admin/inspection/deleted-after-accepted"},
			{Method: "GET", Path: "/admin/points/ledger"},
		},
	},
}
